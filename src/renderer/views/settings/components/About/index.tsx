...
export const About = () => {
  return (
    ...
    <a id="about" name="about">
      <Header>About Heliox</Header>
      <Row>
       <Title>
       Heliox is a fork of <a rel="noopener" target="_blank" href="https://github.com/wexond">Wexond Browser</a> by <a rel="noopener" target="_blank" href="https://github.com/IroniumStudios">Damon Smith</a>.
       </Title>
     </Row>
     <Row>
       <p>
     ...
     <Row>
       <p>&nbsp;&nbsp;
         <a rel="noopener" target="_blank" href="https://github.com/IroniumStudios/Heliox">
         <img width="64px" title="Heliox Logo (Click Me!)" alt="app_icon.png" className="appicon" src={APP_ICON}></img></a>
       </p>
     </Row>
     <Row>
       <p>
     ...
     <Row>
       <p>
         <a rel="noopener" target="_blank" href="https://github.com/IroniumStudios/Heliox">App Version</a>: {AppVer}
         <br/>
         <br/>
